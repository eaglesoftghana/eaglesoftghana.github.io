  ...
  <header class="sticky top-0 z-50 shadow-md backdrop-blur-lg" :class="navBgColor">
    <nav aria-label="Global" class="flex items-center justify-between p-3 lg:px-8 mx-auto max-w-7xl">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <NuxtLink :href="{ name: 'index' }" active-class="dark:text-zinc-100 text-global"
        ...
        <div class="relative" @mouseover="isProductListShown = true" @mouseleave="isProductListShown = false">
          <NuxtLink :to="{ name: 'products' }" active-class="dark:text-zinc-100 text-global"
            exact-active-class="dark:text-zinc-100 text-global"
            class="text-sm font-semibold dark:text-slate-400 hover:text-zinc-700 dark:hover:text-body flex">
            <span>
              Products
            </span>
            <ChevronDown />
          ...
          <Transition name="fade" mode="in-out">
            <div v-if="isProductListShown"
              ...
              <div class="flex flex-col gap-4 p-4">
                <FlexListWithIcon :to="{ name: 'products', hash: '#smart-sms' }" heading="eagle school manager"
                ...
                <FlexListWithIcon :to="{ name: 'products', hash: '#echurch' }" heading="eagle church suite"
        ...
        <NuxtLink :href="{ name: 'contact' }" active-class="dark:text-zinc-100 text-global"
          exact-active-class="dark:text-zinc-100 text-global"
          class="text-sm font-semibold dark:text-slate-400 hover:text-zinc-700 dark:hover:text-body">
          Contact
        </NuxtLink>
              ...
              <div class="-my-6 divide-y divide-white/10">
                <div class="space-y-2 py-6">
                  ...
                  <div class="relative block" @mouseover="isProductListShown = true"
                    ...
                    <NuxtLink :to="{ name: 'products' }" active-class="dark:text-zinc-100 text-global"
                      exact-active-class="dark:text-zinc-100 text-global"
                      class="text-sm font-semibold dark:text-slate-400 hover:text-zinc-700 dark:hover:text-body flex justify-between items-center">
                      Products
                      ...
                      <div v-if="isMenuShown"
                        ...
                        <div class="flex flex-col gap-4 p-4 relative ">
                          <FlexListWithIcon :to="{ name: 'products', hash: '#smart-sms' }"
                            heading="eagle school manager" :icon="PieChartIcon"
