...
<template>
      ...
      <ESSection class="py-12 text-center">
            ...
            <p v-fade-in class="text-lg mb-8">
                  Whether you require a custom mobile app or specialized systems like Clinic Plus, Eaglesoft Ghana
            ...
            <div v-fade-in class="flex justify-center flex-wrap md:flex-nowrap gap-4">
                  <NuxtLink :to="{ name: 'contact', query: { 'type': 'custom' } }"
                    class="px-8 py-3 w-full md:w-auto text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition duration-150 shadow-lg">
                        Request Custom Project
                  </NuxtLink>
                  <NuxtLink :to="{ name: 'products' }"
                    class="px-8 py-3 w-full md:w-auto text-lg font-medium shadow-md outline rounded-md dark:text-indigo-600 bg-body hover:bg-slate-800 hover:text-white hover:outline-0 hover:dark:text-white transition duration-150">
      ...
      <ESSection>
            <section class="mt-20 py-12 text-center">
                  ...
                  <div v-fade-in class="flex justify-center flex-wrap md:flex-nowrap basis-full gap-4">
                        ...
                        <NuxtLink :to="{ name: 'products' }"
                          class="px-8 py-3 w-full md:w-auto text-lg font-medium shadow-md outline rounded-md dark:text-white bg-body hover:bg-slate-800 hover:text-white hover:outline-0 hover:dark:text-white transition duration-150">
                              View All Products
                        </NuxtLink>
                  </div>
            </section>
