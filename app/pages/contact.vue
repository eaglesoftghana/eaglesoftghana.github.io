<script lang="ts" setup>
      ...
      useSeoMeta({
            title: 'contact • eaglesoft ghana'.toString().toUpperCase(),
            ogTitle: 'contact • eaglesoft ghana'.toString().toUpperCase(),
            description: 'Get in Touch with Eaglesoft Ghana. Whether you need a demo for our specialized SaaS products, are planning a custom web or mobile app, or require expert support for your computer and network systems, Eaglesoft Ghana is here to help.',
            ogDescription: 'Get in Touch with Eaglesoft Ghana. Whether you need a demo for our specialized SaaS products, are planning a custom web or mobile app, or require expert support for your computer and network systems, Eaglesoft Ghana is here to help.',
            ...
            <div class="grid lg:grid-cols-5 gap-12">
                  <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="flex items-start">
                              <svg class="w-6 h-6 text-global-50 dark:text-body mr-4 shrink-0 mt-1" fill="none"
